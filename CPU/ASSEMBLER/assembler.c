...
char* getFunc3(char* instruction, char* type) {
	...
	if(strcmp(type,"I_TYPE") == 0) {
		...
		if(strcasecmp(instruction, "nop") == 0 ) return "000";
...
char * encodeToFormat(FILE *fo, char *keyword, char *type, char *destination_register, char *src1_register, char *src2_register, char *immediate, char *base_register , char* prev_destination_register1	, char *prev_prev_destination_register1)
{
	...
	/*
	As the worse case 2 NOP s added before id the previous destination register used  R-type
	Need to check is this the optimal way and correct
	Need more or less
	*/
    if (strcmp(type, "R_TYPE") == 0)
    {	
		if(strcmp(src1_register,prev_destination_register1)==0 || strcmp(src2_register,prev_destination_register1 )==0){
			sprintf(pline, "%.7s%.5s%.5s%.3s%.5s%.7s", func7, src2_register, src1_register, func3, destination_register, opcode);
			fputs(pline, fo);
			fputs("\n", fo);
			printf("2nops added\n");
			return "22222";
		}else if(strcmp(src1_register,prev_prev_destination_register1)==0 || strcmp(src2_register,prev_prev_destination_register1 )==0){
			/*sprintf(pline, "%.12s%.5s%.3s%.5s%.7s", "0000000000000000", "00000", "000", "00000", "0010011");
			fputs(pline, fo);
			fputs("\n", fo);
			printf("1nops added\n");*/
			sprintf(pline, "%.7s%.5s%.5s%.3s%.5s%.7s", func7, src2_register, src1_register, func3, destination_register, opcode);
	...
	/*
	As the worse case 2 NOP s added J-type instruction  
	Need to check is this the optimal way and correct
	Need more or less
	*/
	...
	/*
	As the worse case 2 NOP s added before id the previous destination register used 
	Need to check is this the optimal way and correct
	Need more or less
	*/
    else if (strcmp(type, "I_TYPE") == 0)
    {
        ...
        if (
            ...
            strcasecmp(keyword, "lhu") == 0)
        {
			if(strcmp(base_register,prev_destination_register1)==0){
				/*sprintf(pline, "%.12s%.5s%.3s%.5s%.7s", "0000000000000000", "00000", "000", "00000", "0010011");
				fputs(pline, fo);
				fputs("\n", fo);
				sprintf(pline, "%.12s%.5s%.3s%.5s%.7s", "0000000000000000", "00000", "000", "00000", "0010011");
				...
				printf("2nops added\n");
				return "22222";
			}else if(strcmp(base_register,prev_prev_destination_register1)==0){
				/*sprintf(pline, "%.12s%.5s%.3s%.5s%.7s", "0000000000000000", "00000", "000", "00000", "0010011");
				fputs(pline, fo);
				fputs("\n", fo);*/
				sprintf(pline, "%.12s%.5s%.3s%.5s%.7s", imm11_0, base_register, func3, destination_register, opcode);
			...
			if(strcmp(src1_register,prev_destination_register1)==0){
				/*sprintf(pline, "%.12s%.5s%.3s%.5s%.7s", "0000000000000000", "00000", "000", "00000", "0010011");
				fputs(pline, fo);
				fputs("\n", fo);
				sprintf(pline, "%.12s%.5s%.3s%.5s%.7s", "0000000000000000", "00000", "000", "00000", "0010011");
				...
				printf("2nops added\n");
				return "22222";
			}else if(strcmp(src1_register,prev_prev_destination_register1)==0){
				/*sprintf(pline, "%.12s%.5s%.3s%.5s%.7s", "0000000000000000", "00000", "000", "00000", "0010011");
				fputs(pline, fo);
				fputs("\n", fo);*/
				sprintf(pline, "%.12s%.5s%.3s%.5s%.7s", imm11_0, src1_register, func3, destination_register, opcode);
	...
	*/
	...
	/*
	As the worse case 3 NOP s added after branch type
	Need to check is this the optimal way and correct
	Need more or less
	*/
...
int main(int argc, char *argv[])
{
    ...
    char *in_token;
    int lineNumber = 0;
	char * prev_destination_register ;
	char * prev_prev_destination_register;
        ...
        */
		...
		
        {
            ...
            else
            {
				...
				//printf("Before dd %s %s %s\n",prev_destination_register, test1, src2_register);
                if (pch)
                {
        ...
        prev_destination_register = encodeToFormat(fo, keyword, type, destination_register, src1_register, src2_register, immediate, base_register, prev, prev_prev);
		if(strcmp(prev_destination_register,"22222")==0){
			strcpy(prev_prev, "22222");
		}else{
			strcpy(prev_prev, prev);
		}
		strcpy(prev, prev_destination_register);
		printf("After %s %s\n",prev_destination_register, prev_prev );
		//printf(prev_destination_register);
    }
